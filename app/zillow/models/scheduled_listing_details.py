...
class ScheduledListingDetail(Base):
    ...
    schools: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    tax_history: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    ...
    original_photos: Mapped[list | None] = mapped_column(JSONB, nullable=True)
