...
class UnderwritingCompSet(Base):
    ...
    # Amenity flags for the comp — nullable with no default, so an unanswered
    # flag stays NULL ("unknown") instead of being recorded as a definite "no".
    # Unlike is_favourite above, which is a deliberate analyst action and so is
    # always one of true/false.
